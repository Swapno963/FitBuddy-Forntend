export default function classNameShedule() {
  ...
  return (
    <div className="pt-12 mt-12 bg-blue-50 py-12">
      <h3 className="text-center text-5xl font-bold text-blue-700">CLASSES SCHEDULE</h3>
      <p className="text-center pt-5 font-semibold leading-relaxed text-md">
      ...
      <p className="text-center text-3xl py-12 font-bold text-gray-600">Sunday / Monday / Tusday</p>
